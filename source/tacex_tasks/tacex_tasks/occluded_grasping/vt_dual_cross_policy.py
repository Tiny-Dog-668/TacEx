"""Bidirectional vision/tactile cross-attention policy without alpha mixing."""
...
class OccludedGraspingVTDualCrossPolicy(GaussianMixin, Model):
    """Compute V' and T', then use fixed residual fusion: V + V' and T + T'."""
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if not self.tactile_keys:
            raise ValueError("No tactile observation keys found for dual-cross policy")
